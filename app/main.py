...
async def main():
    ...
    # FSM Storage
    # Si USE_MONGO_FSM=1, puedes cambiar a MongoStorage (aiogram lo soporta),
    # pero para producción personal MemoryStorage es suficiente.
    ...
    # Dependency Injection (aiogram DI) 5
